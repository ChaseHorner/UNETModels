...
import models.unet_shallow4 as unet_shallow4
import models.unet_shallow16 as unet_shallow16
import os
...
def train_and_evaluate_model(model_path, terminal=False):
    ...
    model = unet.Unet() if configs.BASE_MODEL == 'unet8' else \
            ...
            else unet_shallow4.UnetShallow4() if (configs.BASE_MODEL == 'unet_shallow4') or (configs.BASE_MODEL == 'unet_shallow')\
